        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-2xl shadow-soft border border-gray-100 p-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              By accessing and using Medicoo's healthcare platform, you agree to be bound by these Terms of Service. 
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3 p-4 bg-warning-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">{MEDICAL_DISCLAIMER_FULL}</p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-center space-x-4 p-4 bg-primary-50 rounded-xl">
                ...
                <div>
                  ...
                  <div className="text-gray-600 text-sm">legal@medicoo.in</div>
                </div>
              </div>
